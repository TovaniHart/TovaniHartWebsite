...
export const EMPLOYEE_CONSTANTS: EmployeeProps[] = [
  ...
  },
  {
    ...
    title: "Designer",
    biography:
      "Eric has over 15 years experience as a multi-disciplinary designer and artisan. He attended the University of Washington and earned degrees in both Architectural and Industrial Design, two unique yet complimentary practices at the foundation of his creative skill set. This background affords Eric the ability to balance large scale / big picture planning with small scale / detailed craft. \n His design experience includes mixed-used, residential, and institutional buildings, as well as custom furniture. Eric became a LEED AP to facilitate the important work of integrating sustainability into the built environment. His focus on user experience is a core driver behind his ability to produce functionally and aesthetically pleasing environments. In his spare time, he enjoys volunteering for a non-profit focused on old-growth forest conservation, creating in his workshop, photography, and playing music.",
  },
  {
    name: "Chrissy Burd",
